...
export const ArrowAltIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
    <path
...
export const BackgroundIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
...
export const ProhibitIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
...
export const PromptThreeLinesIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
    <g opacity="0.5">
      <mask
        id="mask0_72_137"
...
export const TextEditorIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="none" {...props}>
